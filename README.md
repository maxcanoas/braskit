...
A excecao e a placa de meio ambiente, que chegou quase quadrada (1118x960).
Cortar para 3:2 decepava o losango, entao ela foi reduzida pela altura e teve
as laterais estendidas repetindo a coluna da borda (`extend` com
`extendWith: "copy"`, no sharp). Com cor chapada, o degrade do fundo deixaria
...
mais longo e a unica ficha com detalhe e kit minimo juntos). As 45 saem do
...
(as seis placas e a bolsa, campo `fabricacaoPropria` em `js/produtos.js`).
